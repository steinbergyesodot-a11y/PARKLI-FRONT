...
type MyPayload = JwtPayload & { _id?: string };
...
export function EditDriveway(){
  ...
  // Fetch existing driveway data
  useEffect(() => {
    async function fetchDriveway() {
      try {
        setLoading(true);
        const response = await axios.get(
          `${import.meta.env.VITE_BACKEND_URL}/api/driveways/${drivewayId}`,
          {
            headers: {
        ...
        const driveway = response.data.driveway || response.data;
        setFormData({
          name: driveway.name || "",
    ...
    return (
      <>
        ...
        <div className="listing-intro">
          <h2 className="listing-title">Update your driveway</h2>
          <p className="listing-subtitle">
            Make changes to your listing to keep information current and attract more renters.
          </p>
          <button className="listing-start-btn primaryBtn" onClick={handleStartEditing}>
            Start editing
          </button>
        </div>
      </>
                  ...
                  <label className="uploadArea">
                    ...
                    <input
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                        ...
                        const totalImages = formData.existingImages.length + formData.newImages.length + newFiles.length;
              ...
              <div className="reviewOuterBox">
                <section className="reviewBox">
                  ...
                  <p className="agreementText">
                    By saving your changes, you confirm that all information is accurate and
                    that you continue to follow our hosting rules and community guidelines.
                  </p>
